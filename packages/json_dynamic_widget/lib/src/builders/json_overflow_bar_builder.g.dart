...
class JsonOverflowBar extends JsonWidgetData {
  JsonOverflowBar({
    ...
    this.children = const <JsonWidgetData>[],
          ...
          jsonWidgetBuilder: () => JsonOverflowBarBuilder(
...
class JsonOverflowBarBuilderModel extends JsonWidgetBuilderModel {
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      ...
      'overflowAlignment': OverflowBarAlignment.start == overflowAlignment
          ? null
          : overflowAlignment,
      'overflowDirection': VerticalDirection.down == overflowDirection
          ? null
